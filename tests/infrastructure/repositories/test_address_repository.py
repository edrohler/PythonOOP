...
def test_update_address(address_repository, test_session):
    address = Address(address_line_1="123 Main St", city="Anytown", state="NY", zipcode="12345", person_id=1)
    ...
    assert updated_address.zipcode == "12345"
    
def test_delete_address(address_repository, test_session):
    address_to_delete = Address(address_line_1="123 Main St", city="Anytown", state="NY", zipcode="12345", person_id=1)
